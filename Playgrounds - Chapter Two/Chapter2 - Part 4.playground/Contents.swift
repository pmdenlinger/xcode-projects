...
crew2[.captain] = Person(
    givenName: "Jean-Luc",
    familyName: "Picard",
    commsMethod: .phone)

crew2[.firstOfficer] = Person(
    givenName: "William",
    familyName: "Riker",
    commsMethod: .email)

crew2[.chiefEngineer] = Person(
    givenName: "Geordi",
    familyName: "LaForge",
    commsMethod: .textMessage)

crew2[.secondOfficer] = Person(
    givenName: "Data",
    familyName: "Soong",
    commsMethod: .fax)

crew2[.councillor] = Person(
    givenName: "Deanna",
    familyName: "Troi",
    commsMethod: .telepathy)

crew2[.securityOfficer] = Person(
    givenName: "Worf",
    familyName: "Son of Mogh",
    commsMethod: .subSpaceRelay)

crew2[.chiefMedicalOfficer] = Person(
    givenName: "Beverly",
    familyName: "Crusher",
